...
export const Content = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Welcome to the Shadow Code</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">We welcome you to this place of mystique and shadows. We are a tribe!!! Get your merchandise today!!!</p>
    </div>
