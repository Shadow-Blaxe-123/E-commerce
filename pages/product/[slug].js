...
// Checking if the zipcode has the correct number of digits
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="block lg:w-1/2 m-auto  w-full lg:h-auto h-64 object-cover object-top px-3 rounded" src="https://m.media-amazon.com/images/I/61JfsRhV+NL._AC_UL400_.jpg"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="leading-relaxed">Introducing the perfect T-shirt for any casual occasion! Made from soft and breathable 100% cotton fabric, this T-shirt is comfortable and durable enough for everyday wear. With a classic slim-fit cut, it flatters any body type, while the range of colors allows you to choose the perfect shade to match your style. The tagless design ensures a comfortable fit, while the double-stitched seams ensure long-lasting durability. Whether you're running errands or hanging out with friends, this T-shirt is the perfect choice. It pairs effortlessly with jeans, shorts, or skirts for a comfortable and stylish look. With its high-quality fabric and attention to detail, this T-shirt is sure to become a wardrobe staple for years to come. Don't miss out on the ultimate combination of comfort and style – order your T-shirt today!</p>
        ...
        <div className="flex">
          ...
          <button className="flex ml-16 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
